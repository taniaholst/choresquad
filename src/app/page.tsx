...
export default function Home() {
  ...
  // On load (and when returning from magic link), detect session
  useEffect(() => {
    const flag = search.get("welcome");
    if (flag) {
      setWelcomeFlag(flag); // <-- just this, nothing chained
    }
  ...
  // Send magic link (redirects back here with ?welcome=1)
  ...
  // Save profile right after sign-in
